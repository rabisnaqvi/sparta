...
?>
<div id="masthead">
<nav class="navbar navbar-default brand-center center-side bootsnav <?php if($sparta['navbar_fixed']){echo "navbar-sticky";} ?> <?php if(( is_single() || is_page() ) && get_field('transparent_menu')) { echo 'navbar-transparent'; } ?>">
    <div class="container">
